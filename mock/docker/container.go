...
func (c *ContainerService) ContainerRename(_ context.Context, _, _ string) error {
	return nil
}
...
func (c *ContainerService) ContainerStatPath(_ context.Context, _, _ string) (container.PathStat, error) {
...
func (c *ContainerService) CopyFromContainer(_ context.Context, _, _ string) (io.ReadCloser, container.PathStat, error) {
...
func (c *ContainerService) CopyToContainer(_ context.Context, _, _ string, _ io.Reader, _ container.CopyToContainerOptions) error {
	return nil
}
