...
/*
This file is pulled directly from https://github.com/moby/moby/blob/master/daemon/internal/stdcopymux/writer.go and
is used to emulate the behavior of the Docker client for usage in the ExecAttach function.

This used to be part of a shareable package in the moby/moby repository, but was moved to an internal package and is no longer accessible.
*/
